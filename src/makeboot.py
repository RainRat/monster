...
# the app file)
bootsegments = ["BANKCODE", "BANKCODE2", "DEBUGINFO_CODE" "SETUP", "FASTTEXT", "MACROCODE", "VSCREEN", "IRQ", "DATA", "LABELS", "FASTCOPY", "EXPR", "UDGEDIT", "CONSOLE", "OBJCODE", "LINKER", "COPYBUFF", "RODATA"]
